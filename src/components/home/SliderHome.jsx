...
const SliderHome = () => {
  ...
  return (
    <div className='w-full lg:h-[734px] flex' style={{ backgroundColor: slides[currentSlide].backgroundColor }}>
      <div className='lg:ml-10 grid lg:block px-5 lg:px-0 lg:py-[150px] w-[100%] justify-center items-center h-[30vh]'>
      ...
      <div className='lg:absolute lg:top-[68px] lg:right-0'>
        <img src={slides[currentSlide].image} alt='' className='lg:w-[544px] w-[50vh] h-[30vh] lg:h-[662px] object-cover' />
      </div>
    </div>
  );
}
