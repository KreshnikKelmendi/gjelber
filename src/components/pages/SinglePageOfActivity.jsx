...
const SinglePageOfActivity = () => {
  ...
  return (
    <div className='bg-[#003249] lg:px-10 px-8 py-7 w-full flex flex-col lg:flex-row'>
        <div className='lg:w-1/2'>
            <p className='font-custom text-[30px] lg:text-[48px] lg:leading-[48.48px] text-[#6ADB84] font-bold'>{title}</p>
            <p className='text-[18px] leading-[25px] pt-[8px] text-[#FFF6E7] lg:w-[575px] lg:text-justify font-normal'>{fullDescription}</p>
            <p className='text-[#F18934] font-normal text-[22px] py-7'>{title}</p>
            <p className='text-[18px] leading-[25px] text-[#FFF6E7] lg:w-[575px] lg:text-justify font-normal'>{fullDescription}</p>
         </div>
